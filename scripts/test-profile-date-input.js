// Script para probar el componente DateOfBirthInput del perfil
console.log('🧪 Probando componente DateOfBirthInput del perfil...\n')
...
// Función para validar fecha como en el componente
...
const validationTestCases = [
  ...
  { input: '31/12/2020', expected: { valid: true, age: 4 } },
  ...
  { input: '15/03/2020', expected: { valid: false, error: 'Você deve ter pelo menos 13 anos' } },
...
if (totalPassed === totalTests) {
  console.log(`\n🎉 ¡Todas las pruebas pasaron! El componente DateOfBirthInput funciona correctamente.`)
} else {
