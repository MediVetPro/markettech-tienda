...
// URLs de imágenes específicas de tecnología (sin personas ni comida)
const techProductImages = {
  // Smartphones - Imágenes específicas de teléfonos
  ...
  // Laptops - Imágenes específicas de laptops
  ...
  // Audio - Imágenes específicas de auriculares
  ...
  // Cameras - Imágenes específicas de cámaras
  ...
  // Gaming - Imágenes específicas de consolas
  ...
  // Wearables - Imágenes específicas de smartwatches
  ...
  // Chargers - Imágenes específicas de cargadores
  ...
  // Cables - Imágenes específicas de cables
  ...
  // Gadgets - Imágenes específicas de gadgets
  ...
  // Computer Parts - Imágenes específicas de componentes
  ...
  // Monitors - Imágenes específicas de monitores
  ...
  // Storage - Imágenes específicas de almacenamiento
  ...
  // Graphics Cards - Imágenes específicas de tarjetas gráficas
  ...
  // Processors - Imágenes específicas de procesadores
  ...
  // Memory - Imágenes específicas de memoria RAM
  ...
  // Power Supplies - Imágenes específicas de fuentes de poder
  ...
  // Cooling - Imágenes específicas de refrigeración
...
async function createTechProducts() {
  try {
    console.log('🚀 Creando productos con imágenes específicas de tecnología...')
    ...
    for (const category of categories) {
      ...
      for (const product of products) {
        try {
          ...
          const imageUrl = techProductImages[product.title]
          if (imageUrl) {
            try {
            ...
            console.log(`  ⚠️ No se encontró imagen de tecnología para: ${product.title}`)
          }
    ...
    console.log(`\n🎉 Se crearon ${totalCreated} productos con imágenes específicas de tecnología!`)
