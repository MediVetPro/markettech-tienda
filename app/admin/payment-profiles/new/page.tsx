  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('✅ Perfil de pago creado:', data)
        router.push('/admin/payment-profiles')
      } else {
        const error = await response.text()
        console.error('Error creando perfil:', error)
        alert('Error al crear el perfil de pago')
      }
    } catch (error) {
      console.error('Error creando perfil:', error)
      alert('Error al crear el perfil de pago')
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Nuevo Perfil de Pago</h1>
              <p className="text-gray-600">Configura los datos fiscales y métodos de pago</p>
            </div>
          </div>
